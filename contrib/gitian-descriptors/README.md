...
Once you've got the right hardware and software:
    ...
    git clone https://github.com/IParn/child.git
    ...
    cd ../gitian-builder
    git pull
    sudo ./bin/gbuild --commit child=HEAD ../child/contrib/gitian-descriptors/gitian.yml

    # Build Win32 dependencies: (only needs to be done once, or when dependency versions change)
    sudo ./bin/gbuild --commit child=HEAD ../child/contrib/gitian-descriptors/boost-win32.yml
    mv build/out/*.* inputs/
    sudo ./bin/gbuild --commit child=HEAD ../child/contrib/gitian-descriptors/deps-win32.yml
    mv build/out/*.* inputs/
    sudo ./bin/gbuild --commit child=HEAD ../child/contrib/gitian-descriptors/qt-win32.yml
    mv build/out/*.* inputs/

    # Build Win32 release:
    sudo ./bin/gbuild --commit child=HEAD ../child/contrib/gitian-descriptors/gitian-win32.yml
